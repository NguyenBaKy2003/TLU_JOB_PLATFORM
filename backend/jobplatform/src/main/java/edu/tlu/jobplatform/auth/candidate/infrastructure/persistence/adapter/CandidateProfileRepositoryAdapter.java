package edu.tlu.jobplatform.auth.candidate.infrastructure.persistence.adapter;
...
import edu.tlu.jobplatform.auth.candidate.infrastructure.persistence.entity.CandidateProfileJpaEntity;
import edu.tlu.jobplatform.auth.candidate.infrastructure.persistence.mapper.CandidateMapper;
import edu.tlu.jobplatform.auth.candidate.infrastructure.persistence.repository.CandidateProfileJpaRepository;
