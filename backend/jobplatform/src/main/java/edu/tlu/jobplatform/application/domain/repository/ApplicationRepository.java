...
public interface ApplicationRepository {
         ...
         */
        Page<Application> searchByCompanyId(UUID companyId, ApplicationStatus status, String keyword,
                        Pageable pageable);

        /**
         * Admin/Employer: tìm đơn theo bài đăng, lọc theo status và keyword.
         */
        Page<Application> searchByJobPostId(UUID jobPostId, ApplicationStatus status, String keyword,
                        Pageable pageable);
        ...
        /**
         * Tìm đơn của ứng viên với lọc đa điều kiện.
         * status null → bỏ qua lọc status.
         * keyword null/blank → bỏ qua lọc text.
         */
        Page<Application> searchByCandidateId(
                        UUID candidateId,
        ...
        /**
         * Đếm số đơn theo từng trạng thái của ứng viên.
