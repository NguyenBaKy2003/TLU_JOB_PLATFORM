...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    actor_id VARCHAR(36),
    -- UUID của user hoặc null (system)
    action VARCHAR(100) NOT NULL,
    -- VD: JOB_PUBLISHED, USER_BANNED
...
CREATE TABLE IF NOT EXISTS audit_logs_2026_q1 PARTITION OF audit_logs FOR
VALUES
FROM ('2026-01-01') TO ('2026-04-01');
CREATE TABLE IF NOT EXISTS audit_logs_2026_q2 PARTITION OF audit_logs FOR
VALUES
FROM ('2026-04-01') TO ('2026-07-01');
CREATE TABLE IF NOT EXISTS audit_logs_2026_q3 PARTITION OF audit_logs FOR
VALUES
FROM ('2026-07-01') TO ('2026-10-01');
CREATE TABLE IF NOT EXISTS audit_logs_2026_q4 PARTITION OF audit_logs FOR
VALUES
