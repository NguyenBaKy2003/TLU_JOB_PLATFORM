  ...
  return (
    <div className="relative flex items-center justify-center w-24 h-24 mx-auto mb-6">
      ...
      <CheckCircle2
        size={52}
        strokeWidth={1.5}
        className="relative text-emerald-500 drop-shadow-sm"
      />
    </div>
  );
}
...
export default function PaymentSuccessPage() {
  ...
  // Confetti-like burst via CSS (no library needed)
  useEffect(() => {
      ...
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4 flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <span className="inline-block mt-1 px-3 py-1 rounded-full bg-emerald-400 text-white text-xs font-bold uppercase tracking-wide">
                Đã thanh toán
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              <QuotaBar
                ...
                used={quota.jobPostUsed ?? 0}
                limit={quota.jobPostLimit ?? 0}
                icon={<Briefcase size={14} />}
              />
              <QuotaBar
                label="Tin nổi bật"
                used={quota.featuredJobUsed ?? 0}
                limit={quota.featuredJobLimit ?? 0}
                icon={<Star size={14} />}
              />
              <QuotaBar
                label="Xem CV"
                used={quota.cvViewUsed ?? 0}
                limit={quota.cvViewLimit ?? 0}
                icon={<Eye size={14} />}
              />
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <FeatureBadge
              active={sub.aiFeatures}
              label="AI tuyển dụng"
              icon={<Cpu size={13} />}
            />
            <FeatureBadge
              active={sub.analyticsAccess}
