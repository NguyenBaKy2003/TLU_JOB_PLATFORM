  ...
  return (
    <div className="w-full max-w-[340px] mx-auto">
      ...
      <p className="text-sm text-gray-500 text-center leading-relaxed mb-1">
        Chúng tôi đã gửi email hướng dẫn đến{" "}
        <span className="font-semibold text-gray-700">{email}</span>.
        <br />Vui lòng kiểm tra hộp thư đến và làm theo hướng
        <br />dẫn để đặt lại mật khẩu của bạn.
      </p>
  ...
  return (
    <AuthLayout imageSrc="/Frame1.png">
      {sentEmail
        ...
        : <RequestForm onSent={setSentEmail} />
      }
    </AuthLayout>
  );
}