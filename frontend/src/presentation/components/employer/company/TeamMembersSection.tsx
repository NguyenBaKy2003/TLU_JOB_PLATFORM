    ...
    >
        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 text-[16px] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 resize-none"
          ...
          <div className="flex justify-end gap-2 mt-4">
            <button
              onClick={resetForm}
              disabled={loading}
              className="flex items-center gap-1.5 px-4 py-2 text-[16px] font-medium text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50"
            >
              <X size={14} /> Hủy
            </button>
            <button
              ...
              disabled={loading}
              className="flex items-center gap-1.5 px-4 py-2 text-[16px] font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50"
            >
      ...
      {sortedMembers.length === 0 && !showForm ? (
        <div className="text-center py-8 text-gray-400">
          ...
          <p className="text-[16px]">Chưa có thành viên nào trong đội ngũ</p>
          ...
          {sortedMembers.map((member) => (
            <div key={member.id} className="flex gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100 group relative">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[16px] font-semibold text-gray-800 truncate">{member.fullName}</h4>
