      ...
      <SectionCard icon={<Trash2 size={16} />} title="Xóa tài khoản">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="shrink-0 px-5 py-2.5 text-[16px] font-semibold text-white bg-red-500 rounded-xl hover:bg-red-600 transition-colors"
          >
            Xóa tài khoản
          </button>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 text-[16px] font-medium text-white bg-red-500 rounded-xl hover:bg-red-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
              >
