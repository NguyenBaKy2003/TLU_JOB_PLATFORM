...
export function MinimumSalaryStep({ onNext, onSkip }: MinimumSalaryStepProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!salary) {
      setError("Vui lòng nhập mức lương mong muốn.");
      return;
    }
    if (!cycle) {
      setError("Vui lòng chọn chu kỳ thanh toán.");
      return;
    }
