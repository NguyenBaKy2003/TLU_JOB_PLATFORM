    ...
    <div className="flex flex-col gap-5 h-full bg-[#1e3a5f]">
      ...
      <div className="px-5">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3.5 py-2.5 rounded-xl bg-white/10 border border-white/10 text-[16px] text-white placeholder:text-white/25 outline-none focus:border-amber-500/50 focus:bg-white/15 transition-colors"
          />
          <button
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[16px] font-medium text-amber-200 truncate">
                    {id}
                  </span>
                </div>
      ...
      {spotlightedJobs.length === 0 && (
        <div className="flex-1 flex flex-col items-center justify-center px-5 pb-5">
          ...
          <p className="text-[16px] text-white/25 text-center">
