...
export const CANDIDATE_PLAN_HIGHLIGHTS: Record<string, string[]> = {
  FREE: [
    ...
    "Tạo 1 CV cơ bản",
    "Nhận tối đa 3 job alert/tháng",
  ],
  PREMIUM: [
    "Ứng tuyển không giới hạn",
    "AI viết & tối ưu CV tự động",
    "CV Boost — đẩy hồ sơ lên đầu",
    "20 lượt phỏng vấn thử AI/tháng",
    "Bộ lọc việc làm nâng cao",
    "Thông tin lương thị trường",
    "Phân tích hồ sơ chuyên sâu",
    "50 job alert tùy chỉnh/tháng",
  ],
  PRO: [
    "Tất cả tính năng Premium",
    "Ứng tuyển & CV Boost không giới hạn",
    "Phỏng vấn thử AI không giới hạn",
    "Hỗ trợ tư vấn nghề nghiệp 1-1",
    "Báo cáo thị trường lao động",
    "Job alert không giới hạn",
    "Ưu tiên hỗ trợ 24/7",
  ],
};
  ...
  return (
    <div
      ...
      className={`relative flex flex-col rounded-2xl border-2 p-6 cursor-pointer transition-all
        ${selected
          ? "border-violet-600 bg-violet-50/30 shadow-md"
          : isPremium
    ...
    >
      ...
      {/* CTA */}
      <div className={`w-full py-2.5 rounded-xl text-[16px] font-semibold text-center transition-colors ${
        selected
