...
import { Globe, MapPin, Users, Mail, Phone, Bookmark, Share2, Bell } from "lucide-react";
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button
                className="w-9 h-9 flex items-center justify-center rounded-xl border border-gray-200 text-gray-400 hover:border-blue-300 hover:text-blue-600 transition-colors">
                <Share2 size={16} />
              </button>
              <button
