    ...
    <div className="relative">
      <button
        ...
        className="
          ...
          py-2.5 text-xs font-semibold text-[#04389E]
          border-2 border-dashed border-[#04389E]/25
          hover:border-[#04389E]/50 hover:bg-[#04389E]/5
  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          active
            ? "bg-[#04389E] text-white shadow-sm shadow-[#04389E]/20"
...
export function CVSectionSidebar({
  ...
  return (
    <aside className="w-full md:w-56 flex-shrink-0 bg-white flex flex-col overflow-hidden rounded-xl border border-slate-200 shadow-sm h-fit min-h-[50vh]">
      {/* Header */}
      ...
      {/* Scrollable list */}
      <div className="flex-1 overflow-y-auto p-2.5 space-y-3 custom-scrollbar py-6">
        {/* Personal info */}
        <div
